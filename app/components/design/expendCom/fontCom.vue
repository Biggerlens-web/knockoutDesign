<template>
    <div class="material_com" v-show="!activeCateId">
        ...
        <div class="cate_list" v-show="!searchModelView">
            ...
            <ul class="defualt_font_list">
                <li v-for="item in defaultFontList" :key="item.id">
                    <img class="font_icon" :src="item.icon" alt="">
                </li>
            </ul>
...
<script lang="ts" setup>
    ...
    import defaultFont1 from '/img/defaultFont1.png'
    import defaultFont2 from '/img/defaultFont2.png'
    import defaultFont3 from '/img/defaultFont3.png'



    const defaultFontList = ref<any[]>([
        {
            id: 1,
            name: '宋体',
            icon: defaultFont1
